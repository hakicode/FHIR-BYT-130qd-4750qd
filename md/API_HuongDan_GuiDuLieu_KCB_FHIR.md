...
- [Hướng Dẫn Gửi Dữ Liệu Khám Bệnh, Chữa Bệnh Qua Cổng Dữ Liệu Báo Cáo](#hướng-dẫn-gửi-dữ-liệu-khám-bệnh-chữa-bệnh-qua-cổng-dữ-liệu-báo-cáo)
    - [Chuẩn dữ liệu](#chuẩn-dữ-liệu)
    - [Quy tắc response thống nhất](#quy-tắc-response-thống-nhất)
  - [Mục lục](#mục-lục)
  ...
  - [II. Gửi dữ liệu XML (QĐ 130/QĐ-BYT)](#ii-gửi-dữ-liệu-xml-qđ-130qđ-byt)
    - [1. Gửi dữ liệu trạng thái KCB (Check-in)](#1-gửi-dữ-liệu-trạng-thái-kcb-check-in)
      ...
      - [Body](#body)
      - [Response](#response-3)
      - [Cấu trúc file XML (XML0)](#cấu-trúc-file-xml-xml0)
    - [2. Gửi dữ liệu khám bệnh, chữa bệnh](#2-gửi-dữ-liệu-khám-bệnh-chữa-bệnh)
      - [Headers](#headers-4)
      - [Body](#body-1)
      - [Response](#response-4)
      - [Cấu trúc file XML wrapper (GIAMDINHHS)](#cấu-trúc-file-xml-wrapper-giamdinhhs)
      - [Mô tả các file XML con](#mô-tả-các-file-xml-con)
  - [III. Gửi dữ liệu JSON (FHIR)](#iii-gửi-dữ-liệu-json-fhir)
    ...
    - [3. Nạp bác sĩ và vai trò (Practitioner)](#3-nạp-bác-sĩ-và-vai-trò-practitioner)
      - [Request Body — Practitioner](#request-body--practitioner)
      - [Request Body — PractitionerRole](#request-body--practitionerrole)
      - [Response](#response-7)
    - [4. Bổ sung thông tin BHYT (Coverage)](#4-bổ-sung-thông-tin-bhyt-coverage)
      - [Request Body (JSON Patch)](#request-body-json-patch)
      - [Response](#response-8)
    - [5. Bổ sung thông tin thuốc (Medication)](#5-bổ-sung-thông-tin-thuốc-medication)
      - [Request Body (JSON Patch)](#request-body-json-patch-1)
      - [Response](#response-9)
    ...
    - [7. Cập nhật kết quả quyết toán BHXH (ClaimResponse)](#7-cập-nhật-kết-quả-quyết-toán-bhxh-claimresponse)
      - [Request Body (JSON Patch)](#request-body-json-patch-2)
